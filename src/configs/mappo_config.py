...
CFG_AGENT.update(
    {
        "rollouts": 4096,
        "learning_epochs": 3,
        "mini_batches": 8,  # Adjusted from 8 to 16
        "entropy_loss_scale": 0.01,  # Adjusted from 0.05
        "random_timesteps": 10000,  # Adjusted from 5000
        "learning_starts": 15000,  # Adjusted from 8000
        "learning_rate": 3e-4,  # Adjusted from 1e-4
        "ratio_clip": 0.2,  # Adjusted from 0.1
        "kl_threshold": 0.015,  # Adjusted from 0.01
...
CFG_TRAINER = {
    ...
    "opponent_freeze_duration": 30_000,  # How long to freeze opponent policy and value network NOTE: CUSTOM CFG - see README.md
